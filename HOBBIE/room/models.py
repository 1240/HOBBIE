...
class Room(models.Model):
    ...
    hash_tags = models.CharField(verbose_name="Ключевые слова - для того, чтобы людям было проще найти вашу комнату",
    ...
    room_to_date = models.DateTimeField(null=True, blank=True,
                                        verbose_name="Дата мероприятия (указывать не обязательно)")
